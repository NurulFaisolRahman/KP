...
import com.example.shin.disposisi.FileBidang.Arsip_Bidang;
import com.example.shin.disposisi.FileBidang.Disposisi_Bidang;
import com.example.shin.disposisi.FileBidang.ViewPagerAdapterBidang;
...
public class Seksi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapterBidang.TambahFragmentBidang(new DisposisiSeksi(), "Disposisi");
        viewPagerAdapterBidang.TambahFragmentBidang(new ArsipSeksi(), "Arsip");
